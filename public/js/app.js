...
function removeCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().patch("/remove-cart", pizza).then(function (res) {
    cartCounter.innerText = res.data.totalQty;
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: "success",
      timeout: 1000,
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 10:
                          ...
                          (0,_apiService__WEBPACK_IMPORTED_MODULE_1__.placeOrder)(formObject); // // Verify card
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoodles"] = self["webpackChunkfoodles"] || [];
